 ...
 * @throw
 *  m_error_num_null_pointer
 *  m_error_num_barn_fire
 */
extern bool m_bus_read(miniat *m, m_uword address, m_uword *data, m_uword *int_tripped);
 ...
 *  A boolean indicating whether or not the bus transaction is complete.
 */
extern bool m_bus_write(miniat *m, m_uword address, m_uword data, m_uword *int_tripped);
 ...
 */
extern void m_bus_reset(miniat *m);
 ...
 */
extern void m_bus_shuffle(miniat *m);
#endif
