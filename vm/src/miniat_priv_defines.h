...
/* Start Stall Durations */
#define M_RAM_STALL_DURATION              2 //!< Number of minimum cycles ram accesses take
#define M_IVT_STALL_DURATION              0 //!< Number of minimum cycles interrupt vector table accesses take
#define M_GPIO_STALL_DURATION             0 //!< Number of minimum cycles gpio accesses take
#define M_CSR_STALL_DURATION              0 //!< Number of minimum cycles control status register accesses take
...
#define M_PERIPHERAL_STALL_DURATION       0 //!< Number of minimum cycles peripheral accesses take on top of peripheral access time
#define M_NO_STALL_DURATION               0 //!< Amount of cycles a no stall is considered, should always be 0
/* End Stall Durations */
